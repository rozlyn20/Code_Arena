...
export default function Features() {
  const coreFeatures = [
    ...
    },
    {
      ...
      description: 'Instant sandbox environments configured in seconds. Setup language runtimes, coding prompts, and drawing whiteboards on-demand.',
  ...
  const placementFeatures = [
    ...
    },
    {
      ...
      description: 'Simulate high-pressure placements with customizable coding countdowns and automatic code freeze locks.',
      icon: <FiClock className="text-xl text-indigo-400" />,
    },
    {
      title: 'AI Feedback',
      description: 'Get a comprehensive breakdown of your performance, highlighting communication, logic, and complexity.',
      icon: <FiMessageCircle className="text-xl text-indigo-400" />,
    },
    {
      title: 'Mock Interviews',
      description: 'Alternate roles to understand how interviewers think. Grade each other using standard tech rubrics.',
      icon: <FiMonitor className="text-xl text-indigo-400" />,
    },
    {
